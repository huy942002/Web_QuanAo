...
<body>
	...
	<div class="row" style="max-width: 100%">
		<div class="col-2" style="max-height: 100%;">
			<main>
				<div class="r-flex flex-row flex-shrink-0 p-3 text-white bg-dark"
					style="height: 100vh;">
					<a href="/"
						class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
						<svg class="bi me-2" width="40" height="32">
              <use xlink:href="#bootstrap" />
            </svg> <span class="fs-4">Web_QuanAo</span>
					</a>
					<hr>
					<ul class="nav nav-pills flex-column mb-auto">
						<li class="nav-item"><a href="/Web_QuanAo/users/index" class="nav-link active"
                  ...
                  <use xlink:href="#speedometer2" />
						...
						<li><a href="
							/Web_QuanAo/categories/index"
							class="nav-link text-white"> <svg class="bi me-2" width="16"
									height="16">
                  <use xlink:href="#table" />
                </svg> Categories
						</a></li>
						<li><a href="/Web_QuanAo/Products/index" class="nav-link text-white"> <svg
									class="bi me-2" width="16" height="16">
                  <use xlink:href="#grid" />
                </svg> Products
						</a></li>
  					...
  					<path
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
							<c:if test="${empty user }"><li><a class="dropdown-item" href="/Web_QuanAo/login">Đăng nhập</button></li></c:if>
